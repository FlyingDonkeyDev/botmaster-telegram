...
class TelegramBot extends BaseBot {
  ...
  constructor(settings) {
    ...
    this.telegraft = new Telegraf(this.credentials.authToken);
   ...
   */
  __createMountPoints() {
    // Usamos telegraft en su lugar
    this.telegraft.on('message', (ctx) => {
  ...
  __sendMessage(rawMessage) {
    return new Promise(async (resolve, reject) => {
      ...
      if (rawMessage.text) {
        resolve({
          result: await this.telegraft.telegram.sendMessage(
            rawMessage.chat_id,
            rawMessage.text,
            extra,
          ),
        ...
        resolve({
          result: await this.telegraft.telegram.sendPhoto(
            rawMessage.chat_id,
